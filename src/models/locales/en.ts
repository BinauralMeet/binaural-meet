export const enTranslate = {
  ...
  btEditIframe: 'ページをブラウズ(非同期)',
  btEndEditIframe: 'ブラウズを終了(同期なし)',
  btEditText: '編集開始(表示位置は非同期)',
  btEndEditText: '編集終了(表示位置を同期)',
  btEditWhiteboard: '編集開始(表示位置は非同期)',
  btEndEditWhiteboard: '編集終了(表示位置は非同期)',
  btEditGDrive: '編集開始・表示更新(表示位置は非同期)',
  btEndEditGDrive: '編集終了(自動更新なし)',
