export const enTranslate = {
  ...
  asName: 'Name',
  asColor: 'Color',
  asColorAvatar:'Avatar',
  asColorText:'Text',
  asAutoColor:'Auto',
  asImage: 'Avatar image',
  asEmail: 'Input email to use Gravatar\'s image',
  asImageFile: 'Upload file to use image file',
  asSave: 'Save and close',
  asCancel: 'Cancel change',
  upload: 'Upload',
  Save: 'Save',
  Clear: 'Clear',
  Cancel: 'Cancel',
