export const enTranslate = {
  ...
  btPin: 'Lock position and size',
  btUnpin: 'Unlock position and size',
  btEdit: 'Start editing (No view sync)',
  btEndEdit: 'End editing (Sync view)',
  btEditIframe: 'Browse page (No sync)',
  btEndEditIframe: 'End browse (No sync)',
  btEditText: 'Edit (No scroll sync)',
  btEndEditText: 'End edit (Sync scroll)',
  btEditWhiteboard: 'Edit (No scroll sync)',
  btEndEditWhiteboard: 'End edit (No scroll sync)',
  btEditGDrive: 'Edit/Update (No scroll sync)',
  btEndEditGDrive: 'End edit (No auto-update)',
  btEndEditYoutube: 'Sync play pos',
  btEditYoutube: 'No sync',
  btMoveTop: 'Move to the top',
  btMoveBottom: 'Move to the bottom',
  btWallpaper: 'Make it wallpaper',
  btCopyToClipboard: 'Copy to clipboard',
  upload: 'Upload',
  Save: 'Save',
  Clear: 'Clear',
  Cancel: 'Cancel',
